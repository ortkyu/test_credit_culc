...
export const Modal = ({ toggle }) => {
  ...
  const handleCalculate = () => {
    if (inputValue < 10000) {
      ...
      setError(null);
      const paymensValue = +inputValue * 12 * 0.13;
      if (paymensValue < 260000) {
        const quantityPayments = Math.floor(260000 / paymensValue);
        const lastPayment = 260000 % paymensValue;
        const arrayPay = Array(quantityPayments).fill(paymensValue);
    ...
    <div className="wrap">
      <div className="modalOne">
        ...
        <div className="checkBox">
          <div className="sum">Итого можете внести в качестве досрочных:</div>
